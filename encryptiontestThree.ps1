...
new-item "C:\temp\secureTest" -itemtype Directory               #this creates the directory.
Add-MpPreference -ControlledFolderAccessProtectedFolders "C:\temp\secureTest"
...
# Store the AESKey into a file. This file should be protected!
